...
Start-Transcript "C:\Temp\Install-VMwareTools.txt"
$ToolsArgs = '/s /v "/qn REBOOT=R ADDLOCAL=ALL REMOVE=Hgfs,VSS,FileIntrospection,NetworkIntrospection,CBHelper,ServiceDiscovery"' #AppDefense,
